      ...
      >
        ...
        >
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4">
            <button
              type="submit"
              className="bg-tertiary shadow-primary rounded-xl px-8 py-3 font-bold text-white shadow-md outline-none transition-transform duration-300 hover:scale-105 disabled:opacity-60"
              disabled={loading}
            >
